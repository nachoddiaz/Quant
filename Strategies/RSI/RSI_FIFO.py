# -*- coding: utf-8 -*-
"""
Created on Sat Mar 16 14:22:22 2024
...
class manager:
    ...
    def __init__(self, data_ready, symbol):
    ...
    def rsi_strategy(self):
        ...
        self.data_ready['RSI'] = ta.rsi(self.data_ready['close'], length=14)
        df = self.data_ready.dropna()
        ...
        df.loc[:, 'crossing_up_70_data'] = crossing_up_70_data
        df.loc[:, 'crossing_down_70_data'] = crossing_down_70_data
        df.loc[:, 'crossing_up_30_data'] = crossing_up_30_data
        df.loc[:, 'crossing_down_30_data'] = crossing_down_30_data
    ...
    def plot_strategie(self):
        mpf.plot(self.df_done, type='candle', style='charles',
                 title='Gráfico de Velas '+self.symbol+' para la estrategia\
                 RSI con FIFO en Escala Logarítmica',
                 ylabel='Precio (USDT)',
                 volume=True,
